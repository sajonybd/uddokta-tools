...
export const defaultSiteSettings: PublicSiteSettings = {
  siteName: "UddoktaBD Premium Tools",
  siteTagline: "Trusted Premium digital tools by UddoktaBD",
  logoUrl: "/logo.png",
  faviconUrl: "/logo.png",
  footerText: "",
  seoTitle: "UddoktaBD Premium Tools - Trusted Premium Digital Tools",
  seoDescription: "Shop trusted premium digital tools with hands-on support from UddoktaBD.",
  supportEmail: "support@uddoktabd.com",
  ...
  whatsappMessage: "Hello! I need support with UddoktaBD Premium Tools.",
  websiteUrl: "https://tools.uddoktabd.com",
